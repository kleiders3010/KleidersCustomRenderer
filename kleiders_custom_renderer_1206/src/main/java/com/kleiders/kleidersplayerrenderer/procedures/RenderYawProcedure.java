...
public class RenderYawProcedure {
	@OnlyIn(Dist.CLIENT)
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		if (entity.getData(KleidersCustomRendererModVariables.PLAYER_VARIABLES).dwarfing) {
			if (_evt.getRenderer() instanceof PlayerRenderer && !(_evt.getRenderer() instanceof com.kleiders.kleidersplayerrenderer.KleidersIgnoreCancel)) {
				ResourceLocation _texture = new ResourceLocation("kleiders_custom_renderer:textures/entities/default.png");
				if (ResourceLocation.tryParse("kleiders_custom_renderer:textures/entities/denji_armor.png") != null) {
					_texture = new ResourceLocation("kleiders_custom_renderer:textures/entities/denji_armor.png");
				}
