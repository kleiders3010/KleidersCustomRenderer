...
public class Modelghostpig<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("kleiders_custom_renderer", "modelghostpig"), "main");
	...
	public Modelghostpig(ModelPart root) {
