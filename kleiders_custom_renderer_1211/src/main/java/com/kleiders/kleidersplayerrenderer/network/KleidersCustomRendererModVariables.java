...
public class KleidersCustomRendererModVariables {
	...
	public static void init(FMLCommonSetupEvent event) {
		KleidersCustomRendererMod.addNetworkMessage(PlayerVariablesSyncMessage.TYPE, PlayerVariablesSyncMessage.STREAM_CODEC, PlayerVariablesSyncMessage::handleData);
	}
	...
	public static class EventBusVariableHandlers {
		...
		public static void clonePlayer(PlayerEvent.Clone event) {
			...
			clone.dwarfing = original.dwarfing;
			if (!event.isWasDeath()) {
			}
	...
	public static class PlayerVariables implements INBTSerializable<CompoundTag> {
		public boolean dwarfing = false;

		@Override
		public CompoundTag serializeNBT(HolderLookup.Provider lookupProvider) {
			CompoundTag nbt = new CompoundTag();
			nbt.putBoolean("dwarfing", dwarfing);
			return nbt;
		}

		@Override
		public void deserializeNBT(HolderLookup.Provider lookupProvider, CompoundTag nbt) {
			dwarfing = nbt.getBoolean("dwarfing");
		}
	...
	public record PlayerVariablesSyncMessage(PlayerVariables data, int target) implements CustomPacketPayload {
		public static final Type<PlayerVariablesSyncMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(KleidersCustomRendererMod.MODID, "player_variables_sync"));
